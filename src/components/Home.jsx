...
const Home = () => {
  return (
    <div className="md:h-[1100px] h-[800px] sm:p-10 bg-[#EDF2F4] flex flex-col justify-around  gap-4 border-x-2  border-dashed">
      ...
      <div>
        <h1 className="font-text md:text-7xl text-3xl font-semibold text-[#1E344F]">
          {" "}
          Discover
      ...
      <div className="max-w-[1312px] md:h-[802px] h-[520px] pl-8 ">
        <div className="w-full h-full bg-hero bg-cover bg-center flex  flex-col justify-between relative">
          ...
          <div className="w-full h-[50%] flex justify-between items-start">
            <div className="lg:w-[237px] w-[150xp] lg:h-[85px] h-[50px] rounded-[32px] shadow-black drop-shadow-2xl lg:m-5 m-0 bg-[#FFFFFF] flex items-center justify-center gap-3 lg:ml-14 z-30">
            ...
            <div className="lg:w-[237px] w-[180px] lg:h-[85px] h-[50px] shadow-black drop-shadow-2xl rounded-[32px] lg:m-5  bg-[#FFFFFF] flex items-center justify-center gap-3 lg:mr-8 z-30">
          ...
          <div className="w-full h-[50%] flex justify-between sm:items-end items-center">
            <div className="flex justify-between w-full  ">
              <div className="md:w-[334px] w-[150px] md:h-[87px] h-[50px] text-left z-30">
                <span
                  className="text-[#000000] font-normal md:text-lg text-xs
                         "
                >
                  The Environmental Social Governance (ESG) DAO that rewards
                  contributors for supporting community.
                </span>
              </div>
              <div className="md:pr-8 pr-0 z-30">
                <button
                  className="md:w-[214px] w-[120px] md:h-[59px] h-[40px] bg-designColor rounded-md
                          text-white"
                >
                  Mint now
                </button>
